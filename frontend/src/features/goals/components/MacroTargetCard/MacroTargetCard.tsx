  ...
  return (
    <div className={styles.card}>
      <div className={styles.cardHeader}>
        ...
        {onEdit && (
          <button className={styles.editButton} onClick={handleEdit} aria-label="Edit macro targets">
      ...
      <div className={styles.macroGrid}>
        ...
        <div className={`${styles.macroItem} ${styles.protein}`}>
          ...
          <div className={styles.macroPercent}>{proteinPercent.toFixed(0)}%</div>
          <div className={styles.macroCalories}>{(protein * 4).toLocaleString()} kcal</div>
        </div>
        ...
        <div className={`${styles.macroItem} ${styles.carbs}`}>
          ...
          <div className={styles.macroCalories}>{(carbs * 4).toLocaleString()} kcal</div>
        </div>
        ...
        <div className={`${styles.macroItem} ${styles.fat}`}>
          ...
          <div className={styles.macroCalories}>{(fat * 9).toLocaleString()} kcal</div>
        </div>
      </div>
